                    ...
                    {project.gallery.map((image, index) => (
                      ...
                      >
                        {failedImages.has(index) ? (
                          <div className="w-full h-64 bg-muted/50 flex items-center justify-center border-2 border-dashed border-muted-foreground/30 rounded-lg">
                          ...
                          <img
                            ...
                            onLoad={() => {
                              ...
                              console.log(`Full URL: ${window.location.origin}${image}`);
                            }}
                          />
                        )}
